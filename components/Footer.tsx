                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-300">
                            <li className="flex items-start"><span className="mr-2 mt-1">📍</span>81/268,Sakkaramman kadu,Bhavani,Erode-638301</li>
                            <li className="flex items-center"><span className="mr-2">📞</span>9488537907,9445698873</li>
